...
import type { Theme, Task, FormErrors } from '../types';
...
function TaskModal({ task, onClose, onSave, title, theme }: TaskModalProps) {
    ...
    const [formData, setFormData] = React.useState({
        ...
        dueDate: task?.dueDate || getLocalDateString(new Date()), // Default to today
                                    ...
                                    value={
                                        typeof formData.dueDate === 'string'
                                            ...
                                            : formData.dueDate instanceof Date
                                                ? getLocalDateString(formData.dueDate)
                                                : ''
                                    }
                                    onChange={handleChange}
                        ...
                        >
                            {isSubmitting ? (
                                <span className="flex items-center">
                                    <i className="fas fa-spinner animate-spin -ml-1 mr-2 text-white"></i>
